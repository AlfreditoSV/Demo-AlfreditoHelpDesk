  <input type="hidden" name="user_idSession" id="user_idSession" value="<?php echo $_SESSION['user_id']?>"> <!-- idUsuario -->
  <input type="hidden" name="rol_idSession" id="rol_idSession" value="<?php echo $_SESSION['rol_id']?>"> <!-- rolUsuario -->
